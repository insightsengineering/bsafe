...
The hazard rate \texttt{N\_WITH\_AE/TOT\_EXP} serves as parameter for the Poisson distribution.
...
The distribution of the log transformed hazard rates converge to a Normal distribution. The log hazards have a standard deviation of 1 (s. @aalen p. 215 and @roychoudhury_bayesian_2020). 
