---
title: |
    | B-Safe Testing and Validation v. 0.0.6
    | for B-Safe v. 0.1
author: | 
...
All scenarios, except the worst scenarios (2, 4 and 12) pass without any failures. For Scenario 2, 4 and 12 the issues stem from problems with the integration within \texttt{RBesT}. The developers of \texttt{RBesT} are informed and will fix this in an upcoming  version.
